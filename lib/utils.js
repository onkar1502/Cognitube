...
const getTimestamp = (createdAt) => {
  if (!createdAt || isNaN(new Date(createdAt).getTime())) return "Recently"
  const now = new Date()
...
module.exports = { convertMetaTagsToObject, createUniqueHandle, getTimestamp, generateID, formatNumber }
